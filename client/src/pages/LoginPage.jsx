    ...
    return (
        ...
        gap-6 rounded-lg shadow-lg">
            ...
            {currentState === "Sign up" && !isDataSubmitted && (
                ...
                focus:ring-2 focus:ring-indigo-500" placeholder="Full Name" required/>
            )}

            {!isDataSubmitted && (
                <>
                <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" 
                placeholder="Email Address" required className="p-2 border border-gray-500
            ...
            {currentState === "Sign up" && isDataSubmitted && (
                ...
                focus:ring-2 focus:ring-indigo-500" placeholder="provide a shord bio..." required></textarea>
            )}
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 required:">
                <input type="checkbox"/>

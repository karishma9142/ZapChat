            ...
            flex items-center justify-between max-sm:flex-col-reverse rounded-lg">
                <form onSubmit={ProfilePage} className="flex flex-col flex-1 gap-5 p-10">
                    ...
                    <label htmlFor="avatar" className="flex items-center gap-3 cursor-pointer">
                        ...
                        <img src={selectedImg ? URL.createObjectURL(selectedImg) : assets.avatar_icon} alt="ProfilePic"
                    ...
                    placeholder="Write profile bio" required rows={4} className="p-2 border border-gray-500 
                    rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"></textarea>
